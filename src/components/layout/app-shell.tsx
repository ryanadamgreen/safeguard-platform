...
function MobileHeader() {
  ...
  return (
    ...
    >
      ...
      {/* Right side */}
      {isAdmin ? (
        <span className="rounded-full bg-[#3730a3]/10 px-3 py-1 text-xs font-semibold text-[#3730a3]">
          Admin
        </span>
      ) : homes.length > 0 ? (
        <div className="relative">
          <select
            ...
            className="appearance-none bg-gray-50 border border-gray-100 rounded-full px-3 py-1.5 text-xs font-medium text-gray-700 pr-6 focus:outline-none focus:ring-2 focus:ring-[#3730a3]/20 max-w-[140px] truncate"
          >
            {homes.map((home) => (
